...
module "ignition_masters" {
  ...
  kubeconfig_fetch_cmd      = "/opt/s3-puller.sh ${aws_s3_bucket_object.kubeconfig_master.bucket}/${aws_s3_bucket_object.kubeconfig_master.key} /etc/kubernetes/kubeconfig"
...
module "ignition_workers" {
  ...
  kube_ca_cert_pem        = "${module.kube_certs.ca_cert_pem}"
  kube_dns_service_ip     = "${module.bootkube.kube_dns_service_ip}"
  kubeconfig_fetch_cmd    = "/opt/s3-puller.sh ${aws_s3_bucket_object.kubeconfig_worker.bucket}/${aws_s3_bucket_object.kubeconfig_worker.key} /etc/kubernetes/kubeconfig"
  kubelet_debug_config    = "${var.tectonic_kubelet_debug_config}"
